...
public class Runner {
    final static String FILES_ROOT_PATH = "src/main/java/javaStageTwo/ioFundamentals/optionalTask/resources/";
    final static String RANDOM_NUMBERS_FILE = "randomnumbers.txt";
    final static String JAVA_PROGRAM_FILE = "RandomJavaTextContainer.java";
